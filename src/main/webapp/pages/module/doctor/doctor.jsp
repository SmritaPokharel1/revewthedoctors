...
<div
	...
	<main class="mdl-layout__content"> 
		...
		<section class="mdl-layout__tab-panel is-active" id="scroll-tab-1">
			 ...
			 <%@include file="admin_doctor_create.jsp"%> 
		</section>
			 
	    <section class="mdl-layout__tab-panel" id="scroll-tab-2"> <%@ include
			file="admin_doctor_list.jsp"%> </section>
...
<script src="${pageContext.request.contextPath}/resources/js/module/doctor/admin_doctor.js"><</script>
</html>