...
<div
	...
	<main class="mdl-layout__content"> 
		...
		<section class="mdl-layout__tab-panel is-active" id="scroll-tab-1">
			 ...
			 <%@include file="admin_district_create.jsp"%> 
		</section>
			 
	    <section class="mdl-layout__tab-panel" id="scroll-tab-2"> <%@ include
			file="admin_district_list.jsp"%> </section>
...
$(document).ready(function() {
	...
	$("#section-2-anchor").click(function(){
		getDistrictList('${pageContext.request.contextPath}');
	});
});
</script>
<script src="${pageContext.request.contextPath}/resources/js/module/district/admin_district.js" type="text/javascript"></script>
