...
<div
	...
	<main class="mdl-layout__content"> 
		...
		<section class="mdl-layout__tab-panel is-active" id="scroll-tab-1">
			 ...
			 <%@include file="admin_hospital_create.jsp"%> 
		</section>
			 
	    <section class="mdl-layout__tab-panel" id="scroll-tab-2"> <%@ include
			file="admin_hospital_list.jsp"%> </section>
...
$(document).ready(function() {
	...
	$("#section-2-anchor").click(function(){
		getHospitalList('${pageContext.request.contextPath}');
	});
});
</script>
<script src="${pageContext.request.contextPath}/resources/js/module/hospital/admin_hospital.js" type="text/javascript"></script>
</html>