					...
					<div class="demo-card-wide mdl-card mdl-shadow--2dp"
						...
						<div class="mdl-card__actions">
							...
							<table>
								<tr>
									<td>Name</td>
									<td id="doctor-name"><a href="${pageContext.request.contextPath}/admin/individualdoctor?doctorId=${review.doctor.doctorId}">${review.doctor.firstName} ${review.doctor.middleName} ${review.doctor.lastName}</a></td>
								</tr>
								<tr>
									<td>Title</td>
