...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer ">
	...
	<main class="mdl-layout__content"> 
		...
		<section class="mdl-layout__tab-panel is-active" id="scroll-tab-1">
			 ...
			 <%@include file="admin_review_create.jsp"%> 
		</section>
			 
	    <section class="mdl-layout__tab-panel" id="scroll-tab-2"> <%@ include
			file="admin_review_list.jsp"%> </section>
...
<script src="${pageContext.request.contextPath}/resources/js/module/review/admin_review.js"></script>
</html>